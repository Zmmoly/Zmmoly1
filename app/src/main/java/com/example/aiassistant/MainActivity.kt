...
class MainActivity : AppCompatActivity(), HotwordDetectionService.HotwordListener {
    ...
    private fun setupHotwordDetection() {
        try {
            ...
            // بدلًا من استخدام BIND_SERVICE_AGENCY غير الموجود، نقوم ببدء الخدمة وإنشاء اتصال
            val hotwordService = if (hotwordServiceIntent != null) applicationContext as? HotwordDetectionService else null
